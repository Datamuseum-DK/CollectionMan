...
public class RichTextServiceTest {
    ...
    public void bitsTexts() {
        assertThat(richText("[[Bits:30003000]]")).isEqualTo("<a href=\"https://ta.ddhf.dk/wiki/Bits:30003000\">Bits:30003000</a>");
    }
    
    @Test
    public void genstandMarkup() {
        //assertThat(richText("11001100")).isEqualTo("<a href=\"11001100\">11001100</a>");
        assertThat(richText("[[Genstand: 11001100]]")).isEqualTo("<a href=\"11001100\">Genstand:11001100</a>");
    ...
    public void urlTests() {
        assertThat(richText(" https://www.ddhf.dk ")).isEqualTo(" <a href=\"https://www.ddhf.dk\">https://www.ddhf.dk</a> ");
    ...
    @Test
    public void qrTests() {
        assertThat(richText("[[QR:50001694]]")).isEqualTo("<a href=\"https://gier.dk/50001694\">QR:50001694</a>");
    }
}
